...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [500,212,-800,-335,-70,22,-3]
    threshold = -20
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 4
    actual = count_positive_sines([80,3,2.5,7,.33])
    print()
